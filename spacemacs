...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(afternoon smyx flatland farmhouse-dark flatland smyx subatomic dakrone twilight-anti-bright material brin spacemacs-dark
                         spacemacs-light)
