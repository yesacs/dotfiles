...
printf "\nRead more here: https://apple.stackexchange.com/questions/10467/how-to-increase-keyboard-key-repeat-rate-on-os-x"
printf "\nOR:"
...
printf "\n\nNeoVim intellisense (these should be autoinstalled)"
